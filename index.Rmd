...
subtitle: "... <html><div style='float:left'></div><hr color='#EB811B' size=1px width=1096px></html>"
...
### Metapaket, welches mit `library(tidyverse)`: 
.pull-left[
...
Jedes Verb, welchen Variablen verändert, kommt in dplyr in drei zusätzlichen
